    ...
    def __init__(self, root):
        ...
        def Kilo():
            if var2.get() == 0:
                ...
                if varl1.get() == "Silk board":
                    switch = {"Marthahalli": 15, "KR Puram": 20, "Tin factory": 18, "Silk board": 0}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Marthahalli":
                    switch = {"Marthahalli": 0, "KR Puram": 13, "Tin factory": 10, "Silk board": 15}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "KR Puram":
                    switch = {"Marthahalli": 13, "KR Puram": 0, "Tin factory": 10, "Silk board": 20}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Tin factory":
                    switch = {"Marthahalli": 10, "KR Puram": 10, "Tin factory": 0, "Silk board": 18}
                    Km.set(switch[varl2.get()])
        ...
        self.lblTitle = Label(Tops, font=('arial', 50, 'bold'), text="      *******CATCH UP CAB********           ")
        self.lblTitle.grid()
        ...
        ReceiptFrame = LabelFrame(Receipt_BottonFrame, width=350, height=300, font=('arial', 10, 'bold'),
        ...
        self.lblFirstname = Label(CustomerName, font=('arial', 12, 'bold'), text="Firstname", bd=7)
        self.lblFirstname.grid(row=0, column=0, sticky=W)
        self.txtFirstname = Entry(CustomerName, font=('arial', 12, 'bold'), textvariable=Firstname, bd=7, insertwidth=2,
                                  justify=RIGHT)
        self.txtFirstname.grid(row=0, column=1)

        self.lblSurname = Label(CustomerName, font=('arial', 12, 'bold'), text="Surname", bd=7)
        self.lblSurname.grid(row=1, column=0, sticky=W)
        self.txtSurname = Entry(CustomerName, font=('arial', 12, 'bold'), textvariable=Surname, bd=7, insertwidth=2,
                                justify=RIGHT)
        self.txtSurname.grid(row=1, column=1, sticky=W)

        self.lblAddress = Label(CustomerName, font=('arial', 12, 'bold'), text="Address", bd=7)
        self.lblAddress.grid(row=2, column=0, sticky=W)
        self.txtAddress = Entry(CustomerName, font=('arial', 12, 'bold'), textvariable=Address, bd=7, insertwidth=2,
                                justify=RIGHT)
        self.txtAddress.grid(row=2, column=1)

        self.lblPostcode = Label(CustomerName, font=('arial', 12, 'bold'), text="Postcode", bd=7)
        self.lblPostcode.grid(row=3, column=0, sticky=W)
        self.txtPostcode = Entry(CustomerName, font=('arial', 12, 'bold'), textvariable=Postcode, bd=7, insertwidth=2,
                                 justify=RIGHT)
        self.txtPostcode.grid(row=3, column=1)

        self.lblTelephone = Label(CustomerName, font=('arial', 12, 'bold'), text="Telephone", bd=7)
        self.lblTelephone.grid(row=4, column=0, sticky=W)
        self.txtTelephone = Entry(CustomerName, font=('arial', 12, 'bold'), textvariable=Telephone, bd=7, insertwidth=2,
                                  justify=RIGHT)
        self.txtTelephone.grid(row=4, column=1)

        self.lblMobile = Label(CustomerName, font=('arial', 12, 'bold'), text="Mobile", bd=7)
        self.lblMobile.grid(row=5, column=0, sticky=W)
        self.txtMobile = Entry(CustomerName, font=('arial', 12, 'bold'), textvariable=Mobile, bd=7, insertwidth=2,
                               justify=RIGHT)
        self.txtMobile.grid(row=5, column=1)

        self.lblEmail = Label(CustomerName, font=('arial', 12, 'bold'), text="Email", bd=7)
        self.lblEmail.grid(row=6, column=0, sticky=W)
        self.txtEmail = Entry(CustomerName, font=('arial', 12, 'bold'), textvariable=Email, bd=7, insertwidth=2,
                              justify=RIGHT)
        self.txtEmail.grid(row=6, column=1)

        # ===============================================Taxi Information==============================================================
        self.lblPickup = Label(TravelFrame, font=('arial', 12, 'bold'), text="Pickup", bd=7)
        self.lblPickup.grid(row=0, column=0, sticky=W)

        self.cboPickup = ttk.Combobox(TravelFrame, textvariable=varl1, state='readonly', font=('arial', 16, 'bold'),
                                      width=14)
        self.cboPickup['value'] = ('', 'Marthahalli', 'KR Puram', 'Tin factory', 'Silk board')
        self.cboPickup.current(0)
        ...
        self.cboDrop = ttk.Combobox(TravelFrame, textvariable=varl2, state='readonly', font=('arial', 16, 'bold'),
                                    width=14)
        self.cboDrop['value'] = ('', 'Marthahalli', 'KR Puram', 'Tin factory', 'Silk board')
        self.cboDrop.current(0)
        self.cboDrop.grid(row=1, column=1)

        self.lblPooling = Label(TravelFrame, font=('arial', 12, 'bold'), text="Pooling", bd=7)
        self.lblPooling.grid(row=2, column=0, sticky=W)

        self.cboPooling = ttk.Combobox(TravelFrame, textvariable=varl3, state='readonly', font=('arial', 16, 'bold'),
                                       width=14)
        ...
        self.chkStandard = Radiobutton(Book_Frame, text="Standard", value=1, variable=carType,
                                       font=('arial', 12, 'bold'), command=selectCar).grid(row=0, column=0, sticky=W)
        self.txtStandard = Label(Book_Frame, font=('arial', 12, 'bold'), width=7, textvariable=Standard, bd=5,
        ...
        self.chkPrimeSedand = Radiobutton(Book_Frame, text="PrimeSedan", value=2, variable=carType,
                                          font=('arial', 12, 'bold'), command=selectCar).grid(row=1, column=0, sticky=W)
        self.txtPrimeSedan = Label(Book_Frame, font=('arial', 12, 'bold'), width=7, textvariable=PrimeSedan, bd=5,
                                   state=DISABLED, justify=RIGHT, bg="white", relief=SUNKEN)
        ...
        self.chkPremiumSedan = Radiobutton(Book_Frame, text="PremiumSedan", value=3, variable=carType,
                                           font=('arial', 12, 'bold'), command=selectCar).grid(row=2, column=0)
        self.txtPremiumSedan = Label(Book_Frame, font=('arial', 12, 'bold'), width=7, textvariable=PremiumSedan, bd=5,
                                     state=DISABLED, justify=RIGHT, bg="white", relief=SUNKEN)
        ...
        self.btnTotal = Button(ButtonFrame, padx=18, bd=7, font=('arial', 10, 'bold'), width=2, text='Total',
                               command=Total_Paid).grid(row=0, column=0)
        self.btnReceipt = Button(ButtonFrame, padx=18, bd=7, font=('arial', 10, 'bold'), width=2, text='Receipt',
                                 command=Receiptt).grid(row=0, column=1)
        self.btnReset = Button(ButtonFrame, padx=18, bd=7, font=('arial', 10, 'bold'), width=2, text='Reset',
                               command=Reset).grid(row=0, column=2)
        self.btnExit = Button(ButtonFrame, padx=18, bd=7, font=('arial', 10, 'bold'), width=2, text='Exit',
